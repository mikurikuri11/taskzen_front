      ...
      <div className="bg-gray-900 py-24 sm:py-32">
        ...
        <div className="relative overflow-hidden pt-8">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 bg-white rounded-xl">
            ...
            >
              <SplideSlide>
                <h2 className='text-3xl font-bold mt-10 mb-5 text-center'>TaskZennとは</h2>
                <p className='mb-10 text-center mx-auto max-w-2xl lg:text-left text-xl'>
              ...
              <SplideSlide>
                <h2 className='text-3xl font-bold mt-10 mb-5 text-center'>ToDoの作成方法</h2>
                  <p className='mb-10 text-center mx-auto max-w-2xl lg:text-left text-xl'>
              ...
              <SplideSlide>
                <h2 className='text-3xl font-bold mt-10 mb-5 text-center'>その後の機能</h2>
                  <p className='mb-10 text-center mx-auto max-w-2xl lg:text-left text-xl'>
